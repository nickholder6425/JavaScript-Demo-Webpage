...
// Arithmetic operators combine with number to form an expression that returns a single number
console.log(a + b);
console.log(a - b);
console.log(a / b);
console.log(a * b);
...
// Comparison operators combine with stings, booleans and numbers to form an expression that evaluates to true or false
// Compares equality

console.log(b == c);
console.log(b != c);

// Compares equality and type (strictly equality)
console.log(b === c);
console.log(b !== c);
